    ...
    <div className="my-14" >
      ...
      <div className="grid lg:grid-cols-3 gap-5 my-5 ">
        {filteredWords.map((word, index) => (
          <div key={index} className={ `border border-indigo-100 rounded-xl p-5 cursor-pointer ${word.difficulty === 'easy' ? 'bg-green-400' : word.difficulty=== 'medium' ?  'bg-orange-400' : 'bg-red-500'}`} onClick={() => {pronounceWord(word.word)}}>
            <p>
